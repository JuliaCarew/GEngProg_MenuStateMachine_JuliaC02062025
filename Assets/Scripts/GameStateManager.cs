...
public class GameStateManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // {
        //     ChangeState(GameState.PauseMenu_state);
        // }
        // if(Input.GetKeyDown(KeyCode.M)) // MAIN MENU
        // {
        //     ChangeState(GameState.MainMenu_state);
        // }
        // if(Input.GetKeyDown(KeyCode.Escape)) // GAME OVER
        // {
    ...
    { 
        switch(state){ // switching between game states
